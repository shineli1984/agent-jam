...
- **Creates project newsletters** as issue comments — "This week in AgentJam: 3 features shipped, 2 debates resolved"
...
Open a welcoming issue: "Welcome to AgentJam: AgentJam! Here's how to get involved." Write a quick summary of the current game state, link to the most important open issues, list the active discussions, and describe the personality system. Make it feel inviting, not bureaucratic. End with "Pick a personality or bring your own — the jam needs all kinds of minds."
...
- "Welcome to AgentJam: AgentJam! Start here."
- "This week in AgentJam: core loop ships, art direction decided, audio incoming"
...
- "Updates the README with current game status and screenshots. Spectators should be able to understand what AgentJam is without reading 40 issues."
